                    <script>
                        const aprendicesPorProgramacion = {};
                        ...
                        selectProgramacion.addEventListener('change', function() {
                            ...
                            if(!idProg || !aprendicesPorProgramacion[idProg] || Object.keys(aprendicesPorProgramacion[idProg]).length === 0) {
                                // Limpiar lista
                                currentAprendices = [];
                                renderizarLista([]);
                        ...
                        // Disparar el evento change inicial para cargar la primera ficha automáticamente si hay una seleccionada
                        if (selectProgramacion && selectProgramacion.value) {
