            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm rounded-4 bg-white p-4 h-100">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ej. Análisis y Desarrollo de Software" value="<?= htmlspecialchars($oldData['nombre'] ?? ''); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="codigo" class="form-label fw-medium text-secondary">Código del Programa</label>
                        <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Ej. 228118" value="<?= htmlspecialchars($oldData['codigo'] ?? ''); ?>" required>
                    </div>

                    <div class="row g-3 mb-3">
                        <div class="col-6">
                            <label for="version" class="form-label fw-medium text-secondary">Versión</label>
                            <input type="text" class="form-control" id="version" name="version" placeholder="Ej. V1" value="<?= htmlspecialchars($oldData['version'] ?? 'V1'); ?>" required>
                        </div>
                        <div class="col-6">
                            <label for="vigencia" class="form-label fw-medium text-secondary">Vigencia</label>
                            <input type="text" class="form-control" id="vigencia" name="vigencia" placeholder="Ej. 2026" value="<?= htmlspecialchars($oldData['vigencia'] ?? '2026'); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            ...
                            <input type="number" class="form-control" id="duracion_lectiva" name="duracion_lectiva" placeholder="Ej. 3120" value="<?= htmlspecialchars($oldData['duracion_lectiva'] ?? ''); ?>" required>
                        </div>
                        <div class="col-6">
                            <label for="duracion_practica" class="form-label fw-medium text-secondary">Duración Práctica (hrs)</label>
                            <input type="number" class="form-control" id="duracion_practica" name="duracion_practica" placeholder="Ej. 864" value="<?= htmlspecialchars($oldData['duracion_practica'] ?? ''); ?>" required>
                        </div>
                    </div>
                </div>
            </div>
